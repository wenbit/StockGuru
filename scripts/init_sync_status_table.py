...
def init_sync_status_table():
    ...
    try:
        ...
        # 读取SQL文件
        sql_file = project_root / 'stockguru-web' / 'database' / 'daily_sync_status_schema.sql'
        ...
        cursor.execute("""
            ...
            WHERE table_name = 'daily_sync_status'
        """)
        result = cursor.fetchone()
        
        if result['count'] > 0:
            print("✅ 表 daily_sync_status 创建成功")
...
if __name__ == '__main__':
    ...
    success = init_sync_status_table()
